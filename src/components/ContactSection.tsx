...
const ContactSection: React.FC = () => {
  ...
  // IMPORTANT: Replace 'YOUR_FORMSPREE_ENDPOINT' with your actual endpoint URL!
  const formspreeEndpoint = process.env.NEXT_PUBLIC_FORMSPREE_ENDPOINT || 'https://formspree.io/f/YOUR_FORMSPREE_ENDPOINT';

  // Updated submit handler with fetch API
        ...
        <div className="max-w-3xl mx-auto bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div>
              ...
              />
              {errors.name && (
                <p id="name-error" className="mt-1 text-sm text-red-600 dark:text-red-400"> {/* Add ID */} 
                  {errors.name.message}
                </p>
              )}
            </div>
            ...
            <div>
              ...
              />
              {errors.email && (
                <p id="email-error" className="mt-1 text-sm text-red-600 dark:text-red-400"> {/* Add ID */} 
            ...
            <div>
              ...
              />
              {errors.subject && (
                <p id="subject-error" className="mt-1 text-sm text-red-600 dark:text-red-400"> {/* Add ID */} 
            ...
            <div>
              ...
              ></textarea>
              {errors.message && (
                <p id="message-error" className="mt-1 text-sm text-red-600 dark:text-red-400"> {/* Add ID */} 
            ...
            <div className="mt-4 text-center h-6"> {/* Reserve space for messages */}
              {submissionStatus === 'success' && (
                <p className="text-green-600 dark:text-green-400">Message sent successfully!</p>
              )}
              {submissionStatus === 'error' && (
                <p className="text-red-600 dark:text-red-400">Failed to send message. Please try again later.</p>
              )}
            </div>
